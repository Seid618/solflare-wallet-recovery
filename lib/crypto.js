 ...
 * @param {string} passwordPath - Path to the file containing the password
 ...
 */
function decryptKeystore(keystorePath, passwordPath) {
    debug('Reading keystore and password files...');
